...
let HomePage = class HomePage {
    constructor(barcodeScanner, surveyDataService, notificationsService, surveyCacheService, studyTasksService, uuidService, router, platform, statusBar, loadingService, alertController, localNotifications, storage, translateConfigService, translate) {
        ...
        this.study = null; // this is defined as null because it is actually needed to render the html
    ...
    ngOnInit() {
        ...
        this.router.events.subscribe((event) => {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_14__.NavigationStart) {
                if (event.url === '/') {
...
module.exports = "ion-content {\n  --offset-top: 1px;\n}\n\n.page-home .moment {\n  font-size: small;\n  color: gray;\n}\n\n.page-home .rotate-90 {\n  display: inline-block;\n  transform: rotate(90deg);\n}\n\n.secondary {\n  color: #04998b;\n}\n\n.welcome-msg {\n  text-align: center;\n  width: 80%;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.enrolment-img-dark {\n  height: 40%;\n  margin-top: 10%;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.enrolment-img-light {\n  height: 35%;\n  margin-top: 10%;\n  margin-left: auto;\n  margin-right: auto;\n}\n\n.enrolment-text {\n  text-align: center;\n  width: 80%;\n  margin-left: auto;\n  margin-right: auto;\n  margin-bottom: 5%;\n  font-weight: bold;\n}\n\nion-button {\n  --border-radius: 15px;\n  width: 80%;\n}\n\nion-footer {\n  padding-top: 10px;\n  padding-bottom: 10px;\n}\n\nion-label {\n  margin-bottom: 3px;\n  margin-top: 3px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
