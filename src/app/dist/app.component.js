...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, notificationsService, surveyDataService, router, storage) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, status_bar_1.StatusBar.setStyle({
                                style: prefersDark.matches ? status_bar_1.Style.Dark : status_bar_1.Style.Light
                            })["catch"](function (e) {
                                console.log(e);
                            })];
                    case 1:
