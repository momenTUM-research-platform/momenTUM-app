...
var PhotoService = /** @class */ (function () {
    ...
    PhotoService.prototype.deletePhoto = function (question) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!question.model) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, filesystem_1.Filesystem.deleteFile({
                                path: question.model,
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error deleting photo:', error_1);
                        return [3 /*break*/, 4];
    ...
    PhotoService.prototype.savePhotoFile = function (photo) {
        return __awaiter(this, void 0, void 0, function () {
